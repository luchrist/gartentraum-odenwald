...
// Ohne echte Referenzen rendert die Section null; der Anker läuft dann ins
// Leere, deshalb den Menüpunkt in diesem Fall unterdrücken.
const SECTION_LINKS = referenzen.length
  ? BASE_LINKS
  : BASE_LINKS.filter((link) => link.href !== "/#referenzen");
      ...
      <nav className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-[2px] md:px-10">
        <a href="/" className="flex items-center">
          <img
            ...
            className="h-20 w-20 object-contain transition-all duration-500 md:h-32 md:w-32"
          />
        </a>
