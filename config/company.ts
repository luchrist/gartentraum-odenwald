...
export const company = {
  ...
  // Die Akquise hat für Instagram (hotelzurpostmomart) und Facebook
  // (Pizzeria-Odenwald) keine echten Profile des Betriebs gefunden, nur
  // Namensvettern. Bis der Kunde eigene Handles liefert, blenden wir alle
  // Social-Icons aus, damit keine falschen Verweise gezeigt werden.
  socialMedia: {
